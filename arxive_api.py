...
# Search parameters
search_query = 'cat:astro-ph.HE' # search for electron in all fields
start = 0                     # retreive the first 5 results
max_results = 10

query = f'search_query={search_query}&sortBy=submittedDate&sortOrder=descending&start={start}&max_results={max_results}'
